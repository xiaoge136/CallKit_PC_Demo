...
/** @fn void nim_super_team_invite_async(const char* tid,
...
/** @fn void nim_super_team_invite_async2(const char* tid,
                                          const char* jsonlist_uids,
 ...
 *                803:群不存在
 */
NIM_SDK_DLL_API void nim_super_team_invite_async2(const char* tid,
                                                  const char* jsonlist_uids,
                                                  const char* invitation_postscript,
                                                  const char* invitation_attachment,
                                                  const char* json_extension,
...
/** @fn void nim_super_team_kick_async(const char* tid,
                                       const char* jsonlist_uids,
                                       const char* json_extension,
                                       nim_super_team_opt_cb_func cb,
                                       const void* user_data)
...
/** @fn void nim_super_team_update_team_info_async(const char* tid,
...
/** @fn void nim_super_team_update_my_property_async(const char* info,
                                                     const char* json_extension,
                                                     nim_super_team_opt_cb_func cb,
                                                     const void* user_data)
 * 更新自己的群属性
 * @param[in] info        json string
 *群组成员信息,包含tid和需要修改的字段（目前支持修改kNIMTeamUserKeyNick、kNIMTeamUserKeyBits、kNIMTeamUserKeyCustom三个字段） (Keys SEE MORE
 *`nim_super_team_def.h` 『群组属性 Json Keys』
 * @param[in] json_extension json扩展参数（备用，目前不需要）
...
/** @fn void nim_super_team_query_all_my_teams_info_async(const char* json_extension,
                                                          nim_super_team_query_all_my_teams_info_cb_func cb,
                                                          const void* user_data)
 * 查询本地所有群信息（默认查询有效群-群有效AND我在群里-）
 * @param[in] json_extension 扩展参数，可以条件获取缓存中有的无效群(我已经不在里面的群OR解散的群)，SDK2.7.0以上支持，例如 "{"include_invalid" :
 * true}"，参数可查询nim_super_team_def.h 搜索本地群组相关信息扩展参数
...
/** @fn void nim_super_team_query_teams_info_by_keyword_async(const char* keyword,
                                                              const char* json_extension,
                                                              nim_super_team_query_all_my_teams_info_cb_func cb,
                                                              const void* user_data)
 * 查询本地所有群信息（默认查询有效群-群有效AND我在群里-）
 * @param[in] keyword 要查询的关键字
 * @param[in] json_extension 扩展参数（备用，目前不需要）
 * @param[in] cb        查询所有群信息的回调函数, nim_super_team_query_all_my_teams_info_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_super_team_query_teams_info_by_keyword_async(const char* keyword,
                                                                      const char* json_extension,
                                                                      nim_super_team_query_all_my_teams_info_cb_func cb,
                                                                      const void* user_data);

/** @fn void nim_super_team_query_my_all_member_infos_async(const char* json_extension,
 ...
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb         查询我的所有群里我的成员信息的回调函数,
 * nim_super_team_query_my_all_member_infos_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 */
...
/** @fn void nim_super_team_query_team_members_async(const char* tid,
 ...
 * @param[in] json_extension 扩展参数，如果include_user_info为true，可以条件获取缓存中有的无效群成员（不在群里了），SDK2.8.0以上支持，例如
 *"{"include_invalid" : true}"，参数可查询nim_super_team_def.h 搜索本地群组相关信息扩展参数
...
/** @fn void nim_super_team_query_team_member_async(const char* tid,
                                                    const char* user_id,
                                                    const char* json_extension,
...
/** @fn void nim_super_team_query_team_info_async(const char* tid,
                                                  const char* json_extension,
...
/** @fn void nim_super_team_query_team_info_online_async(const char* tid,
                                                         const char* json_extension,
                                                         nim_super_team_opt_cb_func cb,
                                                         const void* user_data)
 * 在线查询群信息（从服务器获取）
...
/** @fn void nim_super_team_apply_join_async(const char* tid,
                                             const char* reason,
                                             const char* json_extension,
                                             nim_super_team_opt_cb_func cb,
                                             const void* user_data)
 ...
 * @param[in] reason    附言
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        申请入群的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:群验证方式为拒绝所有人申请
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_apply_join_async(const char* tid,
                                                     const char* reason,
                                                     const char* json_extension,
                                                     nim_super_team_opt_cb_func cb,
                                                     const void* user_data);

/** @fn void nim_super_team_pass_join_apply_async(const char* tid,
 ...
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        同意入群申请的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                509:操作已失效
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_pass_join_apply_async(const char* tid,
                                                          const char* applicant_id,
                                                          const char* json_extension,
                                                          nim_super_team_opt_cb_func cb,
                                                          const void* user_data);

/** @fn void nim_super_team_reject_join_apply_async(const char* tid,
                                                    const char* applicant_id,
                                                    const char* reason,
                                                    const char* json_extension,
                                                    nim_super_team_opt_cb_func cb,
 ...
 * @param[in] reason        附言
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        拒绝入群申请的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_reject_join_apply_async(const char* tid,
                                                            const char* applicant_id,
                                                            const char* reason,
                                                            const char* json_extension,
                                                            nim_super_team_opt_cb_func cb,
...
/** @fn void nim_super_team_add_managers_async(const char* tid,
 ...
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        添加管理员的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:没有权限
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_add_managers_async(const char* tid,
                                                       const char* jsonlist_admin_ids,
                                                       const char* json_extension,
                                                       nim_super_team_opt_cb_func cb,
                                                       const void* user_data);

/** @fn void nim_super_team_remove_managers_async(const char* tid,
                                                  const char* jsonlist_admin_ids,
                                                  const char* json_extension,
                                                  nim_super_team_opt_cb_func cb,
                                                  const void* user_data)
 ...
 * @param[in] jsonlist_admin_ids    uids string array
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        删除管理员的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:没有权限
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_remove_managers_async(const char* tid,
                                                          const char* jsonlist_admin_ids,
                                                          const char* json_extension,
                                                          nim_super_team_opt_cb_func cb,
                                                          const void* user_data);

/** @fn void nim_super_team_transfer_team_async(const char* tid,
 ...
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        移交群主的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:没有权限
 ...
 *                806:群数量上限
 */
NIM_SDK_DLL_API void nim_super_team_transfer_team_async(const char* tid,
                                                        const char* new_owner,
                                                        bool is_leave,
                                                        const char* json_extension,
                                                        nim_super_team_opt_cb_func cb,
...
/** @fn void nim_super_team_update_other_nick_async(const char* info,
                                                    const char* json_extension,
                                                    nim_super_team_opt_cb_func cb,
                                                    const void* user_data)
 * 修改别人的群昵称
 * @param[in] info        json string tlist 包含tid,accid,nick字段 (Keys SEE MORE `nim_super_team_def.h` 『群组属性 Json Keys』
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        修改别人的群昵称的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:没有权限
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_update_other_nick_async(const char* info,
                                                            const char* json_extension,
                                                            nim_super_team_opt_cb_func cb,
                                                            const void* user_data);

/** @fn void nim_super_team_accept_invitation_async(const char* tid,
                                                    const char* invitor,
                                                    const char* json_extension,
                                                    nim_super_team_opt_cb_func cb,
                                                    const void* user_data)
 ...
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        接受邀请的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:没有权限
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_accept_invitation_async(const char* tid,
                                                            const char* invitor,
                                                            const char* json_extension,
                                                            nim_super_team_opt_cb_func cb,
                                                            const void* user_data);

/** @fn void nim_super_team_reject_invitation_async(const char* tid,
                                                    const char* invitor,
                                                    const char* reason,
                                                    const char* json_extension,
                                                    nim_super_team_opt_cb_func cb,
 ...
 * @param[in] reason    附言
 * @param[in] json_extension json扩展参数（备用，目前不需要）
 * @param[in] cb        拒绝邀请的回调函数, nim_super_team_opt_cb_func回调函数定义见nim_super_team_def.h
 * @param[in] user_data APP的自定义用户数据，SDK只负责传回给回调函数cb，不做任何处理！
 * @return void 无返回值
 * @note 错误码    200:成功
 *                802:没有权限
 ...
 *                805:群类型不对
 */
NIM_SDK_DLL_API void nim_super_team_reject_invitation_async(const char* tid,
                                                            const char* invitor,
                                                            const char* reason,
                                                            const char* json_extension,
                                                            nim_super_team_opt_cb_func cb,
...
/** @fn void nim_super_team_mute_member_async(const char* tid,
 ...
 *                802:没有权限
 */
NIM_SDK_DLL_API void nim_super_team_mute_member_async(const char* tid,
                                                      const char* member_id,
                                                      bool set_mute,
                                                      const char* json_extension,
                                                      nim_super_team_opt_cb_func cb,
...
/** @fn void nim_super_team_query_mute_list_async(const char* tid,
                                                  const char* json_extension,
 ...
 *                802:没有权限
 */
NIM_SDK_DLL_API void nim_super_team_query_mute_list_async(const char* tid,
                                                          const char* json_extension,
                                                          nim_super_team_query_mute_list_cb_func cb,
                                                          const void* user_data);

/** @fn void nim_super_team_mute_async(const char* tid,
                                       bool set_mute,
                                       const char* json_extension,
                                       nim_super_team_opt_cb_func cb,
                                       const void* user_data)
 ...
 *                414:参数错误
 */
NIM_SDK_DLL_API void nim_super_team_mute_async(const char* tid,
                                               bool set_mute,
                                               const char* json_extension,
                                               nim_super_team_opt_cb_func cb,
                                               const void* user_data);
