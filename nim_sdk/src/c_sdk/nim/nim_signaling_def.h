...
static const char* kNIMSglEventType = "event_type";          /**< 通知类型 */
static const char* kNIMSglChannelInfo = "channel_info";      /**< 频道信息 */
static const char* kNIMSglFromAccountID = "from_account_id"; /**< 操作者 */
static const char* kNIMSglCustomInfo = "custom_info";        /**< 扩展字段 */
static const char* kNIMSglTimeStamp = "timestamp";           /**< 时间戳 */
static const char* kNIMSglChannelType = "channel_type";      /**< 通话类型,1:音频;2:视频;3:其他 */
static const char* kNIMSglChannelName = "channel_name";      /**< 创建时传入的频道名 */
static const char* kNIMSglChannelID = "channel_id";          /**< 服务器生成的频道id */
static const char* kNIMSglChannelExt = "channel_ext";        /**< 扩展字段 */
static const char* kNIMSglCreateTime = "create_timestamp";   /**< 创建时间点 */
static const char* kNIMSglExpireTime = "expire_timestamp";   /**< 失效时间点 */
static const char* kNIMSglCreatorID = "creator_id";          /**< 创建者的accid */
static const char* kNIMSglInvalid = "invalid";               /**< 频道是否有效 */
static const char* kNIMSglMembers = "members";               /**< 频道内成员信息数组 */
static const char* kNIMSglAccountID = "account_id";           /**< 成员的 accid */
static const char* kNIMSglUID = "uid"; /**< 成员的 uid，大于零有效，无效时服务器会分配随机频道内唯一的uid */
static const char* kNIMSglOfflineEnabled = "offline_enabled"; /**< 是否存离线 */
static const char* kNIMSglDetailedInfo = "info";              /**< 频道详细信息 */
static const char* kNIMSglRequestID = "request_id"; /**< 邀请者邀请的请求id，需要邀请者填写，之后取消邀请、拒绝、接受需要复用该request_id_ */
static const char* kNIMSglPushInfo = "push_info";                  /**< 推送属性 */
static const char* kNIMSglNeedPush = "need_push";                  /**< 是否需要推送，默认false*/
static const char* kNIMSglPushTitle = "push_title";                /**< 推送标题 */
static const char* kNIMSglPushContent = "push_content";            /**< 推送内容 */
static const char* kNIMSglPushPlayload = "push_payload";           /**< 推送自定义字段 */
static const char* kNIMSglNeedBadge = "need_badge";                /**< 是否计入未读计数,默认true */
static const char* kNIMSglAcceptCustomInfo = "accept_custom_info"; /**< 扩展字段 */
static const char* kNIMSglAutoJoin = "auto_join";                  /**< 是否加入，打开后后续参数uid_、join_custom_info_有效 */
static const char* kNIMSglJoinCustomInfo = "join_custom_info"; /**< 加入频道的自定义扩展信息，将在加入频道通知中带给其他频道成员，可缺省 */
