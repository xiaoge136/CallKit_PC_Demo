 ...
 * 计算 MD5，需要调用nim_free_buf(void *data)释放内存
 ...
 * 计算文件的 MD5，需要调用nim_free_buf(void *data)释放内存
...
/** @fn void nim_tool_get_audio_text_async(const char* json_audio_info,
 ...
 *                6104:audioUrl不合法
 */
NIM_SDK_DLL_API void nim_tool_get_audio_text_async(const char* json_audio_info,
                                                   const char* json_extension,
                                                   nim_tool_get_audio_text_cb_func cb,
                                                   const void* user_data);

/** @fn void nim_tool_filter_client_antispam_async(const char* text,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_tool_filter_client_antispam_async(const char* text,
                                                           const char* replace_str,
                                                           const char* lib_name,
                                                           const char* json_extension,
                                                           nim_tool_filter_client_antispam_cb_func cb,
