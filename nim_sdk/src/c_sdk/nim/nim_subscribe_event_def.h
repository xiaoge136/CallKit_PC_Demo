...
/** @typedef void (*nim_publish_event_cb_func)(int res_code, int event_type, const char *event_info_json,
 ...
 */
typedef void (
    *nim_publish_event_cb_func)(int res_code, int event_type, const char* event_info_json, const char* json_extension, const void* user_data);

/** @typedef void (*nim_subscribe_event_cb_func)(int res_code, int event_type, const char *faild_list_json,
 *                                               const char *json_extension, const void *user_data)
 * 订阅事件的回调函数定义
 * @param[out] res_code        结果代码，一切正常200
 ...
 */
typedef void (
    *nim_subscribe_event_cb_func)(int res_code, int event_type, const char* faild_list_json, const char* json_extension, const void* user_data);

/** @typedef void (*nim_unsubscribe_event_cb_func)(int res_code, int event_type, const char *faild_list_json,
 *                                                 const char *json_extension, const void *user_data)
 ...
 */
typedef void (
    *nim_unsubscribe_event_cb_func)(int res_code, int event_type, const char* faild_list_json, const char* json_extension, const void* user_data);
...
/** @typedef void (*nim_query_subscribe_event_cb_func)(int res_code, int event_type, const char *subscribe_list_json,
 *                                                     const char *json_extension, const void *user_data)
 ...
 * @return void 无返回值
 */
typedef void (*nim_query_subscribe_event_cb_func)(int res_code,
                                                  int event_type,
                                                  const char* subscribe_list_json,
                                                  const char* json_extension,
                                                  const void* user_data);

/** @typedef void (*nim_batch_query_subscribe_event_cb_func)(int res_code, int event_type, const char *subscribe_list_json,
 *                                                           const char *json_extension, const void *user_data)
 ...
 * @return void 无返回值
 */
typedef void (*nim_batch_query_subscribe_event_cb_func)(int res_code,
                                                        int event_type,
                                                        const char* subscribe_list_json,
                                                        const char* json_extension,
                                                        const void* user_data);
