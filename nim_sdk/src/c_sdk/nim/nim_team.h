...
/** @fn void nim_team_create_team_async(const char* team_info,
...
/** @fn void nim_team_invite_async(const char* tid,
                                   const char* jsonlist_uids,
                                   const char* invitation_postscript,
                                   const char* json_extension,
                                   nim_team_opt_cb_func cb,
...
/** @fn void nim_team_invite_async2(const char* tid,
                                    const char* jsonlist_uids,
                                    const char* invitation_postscript,
...
NIM_SDK_DLL_API void nim_team_invite_async2(const char* tid,
                                            ...
                                            nim_team_opt_cb_func cb,
                                            const void* user_data);
/** @fn void nim_team_kick_async(const char* tid,
                                 const char* jsonlist_uids,
                                 const char* json_extension,
                                 nim_team_opt_cb_func cb,
                                 const void* user_data)
...
/** @fn void nim_team_update_team_info_async(const char* tid,
...
/** @fn void nim_team_apply_join_async(const char* tid,
                                       const char* reason,
                                       const char* json_extension,
                                       nim_team_opt_cb_func cb,
                                       const void* user_data)
...
/** @fn void nim_team_pass_join_apply_async(const char* tid,
...
/** @fn void nim_team_reject_join_apply_async(const char* tid,
                                              const char* applicant_id,
                                              const char* reason,
                                              const char* json_extension,
                                              nim_team_opt_cb_func cb,
...
/** @fn void nim_team_add_managers_async(const char* tid,
...
/** @fn void nim_team_remove_managers_async(const char* tid,
                                            const char* jsonlist_admin_ids,
                                            const char* json_extension,
                                            nim_team_opt_cb_func cb,
                                            const void* user_data)
...
/** @fn void nim_team_transfer_team_async(const char* tid,
...
/** @fn void nim_team_accept_invitation_async(const char* tid,
                                              const char* invitor,
                                              const char* json_extension,
                                              nim_team_opt_cb_func cb,
                                              const void* user_data)
...
/** @fn void nim_team_reject_invitation_async(const char* tid,
                                              const char* invitor,
                                              const char* reason,
                                              const char* json_extension,
                                              nim_team_opt_cb_func cb,
 ...
 * true}"，参数可查询nim_team_def.h 搜索本地群组相关信息扩展参数
...
/** @fn void nim_team_query_my_all_member_infos_async(const char* json_extension,
...
/** @fn void nim_team_query_team_members_async(const char* tid,
 ...
 *"{"include_invalid" : true}"，参数可查询nim_team_def.h 搜索本地群组相关信息扩展参数
...
/** @fn void nim_team_query_team_member_async(const char* tid,
                                              const char* user_id,
                                              const char* json_extension,
...
/** @fn void nim_team_mute_member_async(const char* tid,
...
/** @fn void nim_team_query_mute_list_online_async(const char* tid,
                                                   const char* json_extension,
...
/** @fn void nim_team_msg_ack_read(const char* tid,
 ...
 *                414:参数错误
 */
NIM_SDK_DLL_API void nim_team_msg_ack_read(const char* tid,
                                           const char* json_msgs,
                                           const char* json_extension,
                                           nim_team_opt_cb_func cb,
                                           const void* user_data);

/** @fn void nim_team_msg_ack_read_ex(const char* tid,
                                      const char* json_msgs,
                                      const char* json_extension,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_team_msg_ack_read_ex(const char* tid,
                                              const char* json_msgs,
                                              const char* json_extension,
                                              nim_team_msg_ack_read_ex_cb_func cb,
                                              const void* user_data);

/** @fn void nim_team_msg_query_unread_list(const char* tid,
                                            const char* json_msg,
                                            const char* json_extension,
                                            nim_team_opt_cb_func cb,
                                            const void* user_data)
 ...
 *                414:参数错误
 */
NIM_SDK_DLL_API void nim_team_msg_query_unread_list(const char* tid,
                                                    const char* json_msg,
                                                    const char* json_extension,
                                                    nim_team_opt_cb_func cb,
                                                    const void* user_data);
 ...
 * @note 错误码    200:成功
 */
NIM_SDK_DLL_API void nim_team_query_members_invitor(const char* tid,
                                                    const char* members,
                                                    nim_team_query_members_invitor_cb_func cb,
                                                    const void* user_data);

/** @fn void nim_team_query_teams_info_by_keyword(const char* keyword,
...
/** @fn void nim_team_get_team_info_batch_sftrans(const char* json_extension,
                                                  nim_team_query_all_my_teams_info_cb_func cb,
                                                  uint64_t time_tag,
                                                  const void* user_data)
 * 查询所有群信息（顺丰专用）
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_team_get_team_info_batch_sftrans(const char* json_extension,
                                                          nim_team_query_all_my_teams_info_cb_func cb,
                                                          uint64_t time_tag,
                                                          const void* user_data);

/** @fn void nim_team_update_tinfo_local(const char *json_info_list,nim_team_update_tinfo_local_cb_func cb_func, const void *user_data)
 * 更新本地缓存的群信息（顺丰专用）
