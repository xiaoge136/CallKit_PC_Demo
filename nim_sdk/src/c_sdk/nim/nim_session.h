...
/** @fn void nim_session_query_last_few_session_async(int limit,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_session_query_last_few_session_async(int limit,
                                                              const char* json_extension,
                                                              nim_session_query_recent_session_cb_func cb,
                                                              const void* user_data);
...
/** @fn void nim_session_query_all_recent_session_with_last_msg_excluded_type_async(const char* json_extension,
                                                                                    nim_session_query_recent_session_cb_func cb,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_session_query_all_recent_session_with_last_msg_excluded_type_async(const char* json_extension,
                                                                                            nim_session_query_recent_session_cb_func cb,
                                                                                            enum NIMMessageType last_msg_excluded_type,
                                                                                            const void* user_data);

/** @fn void nim_session_query_all_recent_session_with_last_msg_excluded_type_async_ex(const char* json_extension,
                                                                                       nim_session_query_recent_session_cb_func cb,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_session_query_all_recent_session_with_last_msg_excluded_type_async_ex(const char* json_extension,
                                                                                               nim_session_query_recent_session_cb_func cb,
                                                                                               const char* last_msg_excluded_type_list,
                                                                                               const void* user_data);

/** @fn void nim_session_delete_recent_session_async(enum NIMSessionType to_type,
                                                             const char* id,
                                                             const char* json_extension,
...
/** @fn void nim_session_delete_recent_session_async_ex(enum NIMSessionType to_type,
                                                        const char* id,
                                                        bool delete_roaming,
                                                        nim_session_change_cb_func cb,
                                                        const void* user_data)
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_delete_recent_session_async_ex(enum NIMSessionType to_type,
                                                                const char* id,
                                                                bool delete_roaming,
                                                                nim_session_change_cb_func cb,
                                                                const void* user_data);

/** @fn void nim_session_delete_session_roaming_async(enum NIMSessionType to_type,
                                                      const char* id,
                                                      const char* json_extension,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_delete_session_roaming_async(enum NIMSessionType to_type,
                                                              const char* id,
                                                              const char* json_extension,
                                                              nim_session_delete_session_roaming_cb_func cb,
                                                              const void* user_data);
...
/** @fn void nim_session_set_unread_count_zero_async(enum NIMSessionType to_type,
                                                     const char* id,
                                                     const char* json_extension,
                                                     nim_session_change_cb_func cb,
                                                     const void* user_data)
...
/** @fn void nim_session_set_multi_unread_count_zero_async(bool super_team,
                                                           const char* unread_count_zero_info_list,
                                                           nim_session_multi_change_cb_func cb,
                                                           const void* user_data)
 * 最近联系人项(多条)未读数清零
 * @param[in] super_team        是否是超大群
 * @param[in] zero_info_list        json array 要清零的会话信息列表 示例[{"type":0,"id":"123"},{"type":1,"id":"789"}]    对方的account
 *id或者群组tid。
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_set_multi_unread_count_zero_async(bool super_team,
                                                                   const char* unread_count_zero_info_list,
                                                                   nim_session_multi_change_cb_func cb,
                                                                   const void* user_data);

/** @fn void nim_session_set_top(enum NIMSessionType to_type,
                                 const char* id,
                                 bool top,
                                 const char* json_extension,
                                 nim_session_change_cb_func cb,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_set_top(enum NIMSessionType to_type,
                                         const char* id,
                                         bool top,
                                         const char* json_extension,
                                         nim_session_change_cb_func cb,
...
/** @fn void nim_session_set_extend_data(enum NIMSessionType to_type,
                                         const char* id,
                                         const char* data,
                                         const char* json_extension,
                                         nim_session_change_cb_func cb,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_set_extend_data(enum NIMSessionType to_type,
                                                 const char* id,
                                                 const char* data,
                                                 const char* json_extension,
                                                 nim_session_change_cb_func cb,
...
/** @fn void nim_session_query_sessiondata_by_id_async(enum NIMSessionType to_type,
                                                       const char* id,
                                                       const char* json_extension,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_query_sessiondata_by_id_async(enum NIMSessionType to_type,
                                                               const char* id,
                                                               const char* json_extension,
                                                               nim_session_query_sessiondata_by_id_cb_func cb,
                                                               const void* user_data);
...
/** @fn void nim_session_set_to_stick_top(const char* session_id,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_set_to_stick_top(const char* session_id,
                                                  enum NIMSessionType to_type,
                                                  const char* ext,
                                                  nim_session_set_to_stick_top_cb_func cb,
                                                  const void* user_data);

/** @fn void nim_session_cancel_stick_top(const char* session_id,
                                          enum NIMSessionType to_type,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_cancel_stick_top(const char* session_id,
                                                  enum NIMSessionType to_type,
                                                  nim_session_cancel_stick_top_cb_func cb,
                                                  const void* user_data);

/** @fn void nim_session_update_stick_top(const char* session_id,
                                          enum NIMSessionType to_type,
                                          const char* ext,
 ...
 *                0:失败
 */
NIM_SDK_DLL_API void nim_session_update_stick_top(const char* session_id,
                                                  enum NIMSessionType to_type,
                                                  const char* ext,
                                                  nim_session_update_stick_top_cb_func cb,
                                                  const void* user_data);
...
/** @fn void nim_session_query_session_hasmore_roammsg(const SessionMainTagInfo* session_main_tag_info,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_session_query_session_hasmore_roammsg(const SessionMainTagInfo* session_main_tag_info,
                                                               nim_session_query_session_hasmore_roammsg_cb_func cb,
                                                               const void* user_data);
...
/** @fn void nim_session_update_session_hasmore_roammsg(const char* json_msg,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_session_update_session_hasmore_roammsg(const char* json_msg,
                                                                nim_session_update_session_hasmore_roammsg_cb_func cb,
                                                                const void* user_data);

/** @fn void nim_session_delete_session_hasmore_roammsg(const SessionMainTagInfo* session_main_tag_info,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_session_delete_session_hasmore_roammsg(const SessionMainTagInfo* session_main_tag_info,
                                                                nim_session_delete_session_hasmore_roammsg_cb_func cb,
                                                                const void* user_data);
