...
extern "C" {
#endif
/** @typedef void (*nim_super_team_event_cb_func)(int res_code, int notification_id, const char *tid, const char *result, const char *json_extension,
 * const void *user_data) 群组通知的回调函数定义
 ...
 * @return void 无返回值
 */
typedef void (*nim_super_team_event_cb_func)(int res_code,
                                             int notification_id,
                                             const char* tid,
                                             const char* result,
...
/** @typedef void (*nim_super_team_query_all_my_teams_info_cb_func)(int team_count, const char *result, const char *json_extension, const void
 * *user_data) 查询我的所有群组信息的回调函数定义
 * @param[out] team_count        有效群组数量
...
/** @typedef void (*nim_super_team_query_my_all_member_infos_cb_func)(int team_count, const char *result, const char *json_extension, const void
 * *user_data) 查询我的所有群里我的成员信息的回调函数定义
 * @param[out] team_count        有效群组数量
 ...
 * @return void 无返回值
 */
typedef void (*nim_super_team_query_my_all_member_infos_cb_func)(int team_count,
                                                                 const char* result,
                                                                 const char* json_extension,
                                                                 const void* user_data);

/** @typedef void (*nim_super_team_query_team_members_cb_func)(const char *tid, int member_count, bool include_user_info, const char *result, const
 * char *json_extension, const void *user_data) 查询群成员的回调函数定义
 ...
 * @return void 无返回值
 */
typedef void (*nim_super_team_query_team_members_cb_func)(int code,
                                                          const char* tid,
                                                          int member_count,
...
/** @typedef void (*nim_super_team_query_team_member_cb_func)(const char *tid, const char *user_id, const char *result, const char *json_extension,
 * const void *user_data) 查询(单个)群成员的回调函数定义
 * @param[out] tid                群组id
...
/** @typedef void (*nim_super_team_query_mute_list_cb_func)(int res_code, int member_count, const char *tid, const char *result, const char
 * *json_extension, const void *user_data) 获取群禁言成员列表的回调函数定义
 * @param[out] res_code        结果代码，一切正常200
 ...
 * @return void 无返回值
 */
typedef void (*nim_super_team_query_mute_list_cb_func)(int res_code,
                                                       int member_count,
                                                       const char* tid,
                                                       const char* result,
                                                       const char* json_extension,
