...
enum NIMSendHttpRequestMethods { kNIMHttpGet = 1, kNIMHttpPost, kNIMHttpPut, kNIMHttpDelete };

/** @typedef void (*nim_send_http_request_cb_func)(int res_code, const char *header, const char *body,
