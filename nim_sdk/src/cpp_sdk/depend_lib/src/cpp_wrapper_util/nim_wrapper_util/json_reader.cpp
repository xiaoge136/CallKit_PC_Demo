...
#include "nim_wrapper_util/json/reader.h"
...
bool CharReaderBuilder::validate(nim_cpp_wrapper_util::Json::Value* invalid) const {
...
// static
void CharReaderBuilder::strictMode(nim_cpp_wrapper_util::Json::Value* settings) {
...
// static
void CharReaderBuilder::setDefaults(nim_cpp_wrapper_util::Json::Value* settings) {
