...
#ifndef NIM_CPP_WRAPPER_UTIL_JSON_H_INCLUDED
#define NIM_CPP_WRAPPER_UTIL_JSON_H_INCLUDED
 ...
 *
 * \remark derived from nim_cpp_wrapper_util::Json::Exception
 */
 ...
 * Example of usage:
 * \code
 * nim_cpp_wrapper_util::Json::Value aValue( StaticString("some text") );
 * nim_cpp_wrapper_util::Json::Value object;
...
public:
     ...
     * Examples:
     *   \code
     *   nim_cpp_wrapper_util::Json::Value null_value; // null
     *   nim_cpp_wrapper_util::Json::Value arr_value(nim_cpp_wrapper_util::Json::arrayValue); // []
     *   nim_cpp_wrapper_util::Json::Value obj_value(nim_cpp_wrapper_util::Json::objectValue); // {}
     *   \endcode
     */
     ...
     *   nim_cpp_wrapper_util::Json::Value aValue(foo);
     *   \endcode
     */
    ...
    void setComment(const char* comment, CommentPlacement placement) { setComment(String(comment, strlen(comment)), placement); }
    /// Comments must be //... or /* ... */
    void setComment(const char* comment, size_t len, CommentPlacement placement) { setComment(String(comment, len), placement); }
    /// Comments must be //... or /* ... */
