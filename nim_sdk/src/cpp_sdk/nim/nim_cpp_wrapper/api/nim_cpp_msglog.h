...
public:
    ...
    typedef std::function<
        ...
        QueryThreadHistoryMsgCallback; /**< 分页查询thread talk消息历史回调模板 */

    using FullTextSearchOnlineAsyncCallback =
        std::function<void(nim::NIMResCode res_code, const QueryMsglogResult& message_list)>; /**< 服务器全文检索回调模板 */
