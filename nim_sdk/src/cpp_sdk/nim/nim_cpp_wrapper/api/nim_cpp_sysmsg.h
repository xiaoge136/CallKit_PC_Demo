...
public:
    ...
    typedef std::function<void(int, int, const std::list<SysMessage>&)> QueryMsgCallback;       /**< 查询系统消息自定义通知回调模板 */
    ...
    typedef std::function<void(NIMResCode, int64_t, int)> NotifySingleSysmsgCallback; /**< 修改（单条）系统消息自定义通知回调模板 */
