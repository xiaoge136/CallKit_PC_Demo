...
public:
    ...
    typedef std::function<void(NIMResCode res_code, const std::list<nim::FriendProfile>& user_profile_list)>
        GetFriendsListCallback; /**< 获取好友回调模板 */
    typedef std::function<void(const std::string& accid, const nim::FriendProfile& user_profile)>
        GetFriendProfileCallback; /**< 获取好友信息回调模板 */
...
public:
    ...
    /** @fn static bool Request(const std::string &accid, NIMVerifyType verify_type, const std::string &msg, const FriendOptCallback &cb, const
     ...
     *                500:未知错误
     */
    static bool Request(const std::string& accid,
