...
public:
    ...
    /** @fn static bool GetUserNameCard(const std::list<std::string>& accids,
    ...
    /** @fn static bool GetUserNameCardOnline(const std::list<std::string>& accids,
                                              const GetUserNameCardCallback& cb,
                                              const std::string& json_extension = "")
     在线查询指定帐号的用户名片
     * @param[in] accids
     ...
     *                20001:还未登陆或登录未完成
     */
    static bool GetUserNameCardOnline(const std::list<std::string>& accids,
                                      const GetUserNameCardCallback& cb,
                                      const std::string& json_extension = "");

    /** @fn static bool UpdateMyUserNameCard(const UserNameCard& namecard,
                                             const UpdateMyUserNameCardCallback& cb,
                                             const std::string& json_extension = "")
     更新自己的用户名片
    ...
    /** @fn static bool ParseSyncSpecialRelationshipChange(const SpecialRelationshipChangeEvent& change_event,
