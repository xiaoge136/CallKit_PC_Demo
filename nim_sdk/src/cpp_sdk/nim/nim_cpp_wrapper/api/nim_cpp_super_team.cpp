...
typedef void (*nim_super_team_query_team_info_online_async)(const char* tid,
                                                            const char* json_extension,
                                                            nim_super_team_event_cb_func cb,
                                                            const void* user_data);
typedef void (*nim_super_team_invite_async)(const char* tid,
                                            const char* jsonlist_uids,
                                            const char* json_extension,
                                            nim_super_team_event_cb_func cb,
                                            const void* user_data);
typedef void (*nim_super_team_invite_async2)(const char* tid,
                                             const char* jsonlist_uids,
                                             ...
                                             const void* user_data);
typedef void (*nim_super_team_kick_async)(const char* tid,
                                          const char* jsonlist_uids,
                                          const char* json_extension,
                                          nim_super_team_event_cb_func cb,
                                          const void* user_data);
...
typedef void (*nim_super_team_update_team_info_async)(const char* tid,
                                                      const char* json_info,
                                                      const char* json_extension,
                                                      nim_super_team_event_cb_func cb_func,
                                                      const void* user_data);
typedef void (*nim_super_team_update_my_property_async)(const char* info,
                                                        const char* json_extension,
                                                        nim_super_team_event_cb_func cb,
                                                        const void* user_data);
typedef void (*nim_super_team_apply_join_async)(const char* tid,
                                                const char* reason,
                                                const char* json_extension,
                                                nim_super_team_event_cb_func cb,
                                                const void* user_data);
typedef void (*nim_super_team_pass_join_apply_async)(const char* tid,
                                                     const char* applicant_id,
                                                     const char* json_extension,
                                                     nim_super_team_event_cb_func cb,
                                                     const void* user_data);
typedef void (*nim_super_team_reject_join_apply_async)(const char* tid,
                                                       const char* applicant_id,
                                                       const char* reason,
                                                       const char* json_extension,
                                                       nim_super_team_event_cb_func cb,
                                                       const void* user_data);
typedef void (*nim_super_team_add_managers_async)(const char* tid,
                                                  const char* jsonlist_admin_ids,
                                                  const char* json_extension,
                                                  nim_super_team_event_cb_func cb,
                                                  const void* user_data);
typedef void (*nim_super_team_remove_managers_async)(const char* tid,
                                                     const char* jsonlist_admin_ids,
                                                     const char* json_extension,
                                                     nim_super_team_event_cb_func cb,
                                                     const void* user_data);
typedef void (*nim_super_team_transfer_team_async)(const char* tid,
                                                   const char* new_owner,
                                                   bool is_leave,
                                                   const char* json_extension,
                                                   nim_super_team_event_cb_func cb,
                                                   const void* user_data);
typedef void (*nim_super_team_update_other_nick_async)(const char* info,
                                                       const char* json_extension,
                                                       nim_super_team_event_cb_func cb,
                                                       const void* user_data);
typedef void (*nim_super_team_accept_invitation_async)(const char* tid,
                                                       const char* invitor,
                                                       const char* json_extension,
                                                       nim_super_team_event_cb_func cb,
                                                       const void* user_data);
typedef void (*nim_super_team_reject_invitation_async)(const char* tid,
                                                       const char* invitor,
                                                       const char* reason,
                                                       const char* json_extension,
                                                       nim_super_team_event_cb_func cb,
                                                       const void* user_data);
typedef void (*nim_super_team_mute_member_async)(const char* tid,
...
typedef void (*nim_super_team_query_mute_list_async)(const char* tid,
                                                     const char* json_extension,
                                                     nim_super_team_query_mute_list_cb_func cb,
                                                     const void* user_data);
typedef void (
    *nim_super_team_msg_ack_read)(const char* tid, const char* json_msgs, const char* json_extension, nim_team_opt_cb_func cb, const void* user_data);
typedef void (*nim_super_team_query_all_my_teams_async)(const char* json_extension,
                                                        nim_super_team_query_all_my_teams_cb_func cb,
                                                        const void* user_data);
typedef void (*nim_super_team_query_all_my_teams_info_async)(const char* json_extension,
                                                             nim_super_team_query_all_my_teams_info_cb_func cb,
                                                             const void* user_data);
typedef void (*nim_super_team_query_teams_info_by_keyword_async)(const char* keyword,
                                                                 const char* json_extension,
                                                                 nim_super_team_query_all_my_teams_info_cb_func cb,
                                                                 const void* user_data);
typedef void (*nim_super_team_query_my_all_member_infos_async)(const char* json_extension,
                                                               nim_super_team_query_my_all_member_infos_cb_func cb,
                                                               const void* user_data);
typedef void (*nim_super_team_query_team_members_async)(const char* tid,
                                                        bool include_user_info,
                                                        const char* json_extension,
                                                        nim_super_team_query_team_members_cb_func cb,
                                                        const void* user_data);
typedef void (*nim_super_team_query_team_member_async)(const char* tid,
                                                       const char* user_id,
                                                       const char* json_extension,
                                                       nim_super_team_query_team_member_cb_func cb,
                                                       const void* user_data);
typedef void (*nim_super_team_query_team_info_async)(const char* tid,
                                                     const char* json_extension,
...
static void CallbackSuperTeamEvent(int res_code,
                                   int notification_id,
                                   const char* tid,
                                   const char* result,
                                   const char* json_extension,
...
static void CallbackSuperTeamChange(int res_code,
                                    int notification_id,
                                    const char* tid,
                                    const char* result,
                                    const char* json_extension,
                                    const void* user_data) {
    CallbackProxy::DoSafeCallback<SuperTeam::SuperTeamEventCallback>(
        user_data,
        [=](const SuperTeam::SuperTeamEventCallback& cb) {
            SuperTeamEvent team_event;
            ParseSuperTeamEvent(res_code, PCharToString(tid), (nim::NIMNotificationId)notification_id, PCharToString(result), team_event);
            CallbackProxy::Invoke(cb, team_event);
        },
...
static void CallbackQueryMySuperTeams(int team_count, const char* result, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<SuperTeam::QueryAllMySuperTeamsCallback>(
        user_data,
        [=](const SuperTeam::QueryAllMySuperTeamsCallback& cb) {
...
static void CallbackQuerySuperTeamMembers(int error_code,
                                          const char* tid,
                                          int member_count,
                                          bool include_user_info,
                                          const char* result,
                                          const char* json_extension,
                                          const void* user_data) {
    CallbackProxy::DoSafeCallback<SuperTeam::QuerySuperTeamMembersCallback>(
        user_data,
...
static void CallbackQuerySuperTeamMember(const char* tid, const char* id, const char* result, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<SuperTeam::QuerySuperTeamMemberCallback>(
        user_data,
        [=](const SuperTeam::QuerySuperTeamMemberCallback& cb) {
...
static void CallbackQueryAllMySuperTeamsInfo(int team_count, const char* result, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<SuperTeam::QueryAllMySuperTeamsInfoCallback>(
        user_data,
        [=](const SuperTeam::QueryAllMySuperTeamsInfoCallback& cb) {
...
static void CallbackQueryMyAllMemberInfos(int count, const char* result, const char* json_extension, const void* user_data) {
    CallbackProxy::DoSafeCallback<SuperTeam::QueryMyAllMemberInfosCallback>(
        user_data,
        [=](const SuperTeam::QueryMyAllMemberInfosCallback& cb) {
...
static void CallbackQuerySuperTeamInfo(const char* tid, const char* result, const char* json_extension, const void* callback) {
    CallbackProxy::DoSafeCallback<SuperTeam::QuerySuperTeamInfoCallback>(
        callback,
        [=](const SuperTeam::QuerySuperTeamInfoCallback& cb) {
...
static void CallbackQueryMutedMemberList(int res_code,
                                         int count,
                                         const char* tid,
                                         const char* result,
                                         const char* json_extension,
...
bool SuperTeam::InviteAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_invite_async)(tid.c_str(), uids.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::InviteAsync2(const std::string& tid,
    ...
    std::string uids;
    StrListToJsonString(ids, uids);
    NIM_SDK_GET_FUNC(nim_super_team_invite_async2)
    (tid.c_str(), uids.c_str(), invitation_postscript.c_str(), invitation_attachment.c_str(), json_extension.c_str(), &CallbackSuperTeamChange,
     cb_pointer);
...
bool SuperTeam::KickAsync(const std::string& tid,
    ...
    std::string uids;
    StrListToJsonString(ids, uids);
    NIM_SDK_GET_FUNC(nim_super_team_kick_async)(tid.c_str(), uids.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::LeaveAsync(const std::string& tid, const SuperTeamEventCallback& cb, const std::string& json_extension /* = ""*/) {
    ...
    NIM_SDK_GET_FUNC(nim_super_team_leave_async)(tid.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::UpdateSuperTeamInfoAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_update_team_info_async)
    (tid.c_str(), team_info.ToJsonString().c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);

    return true;
}

bool SuperTeam::UpdateMyPropertyAsync(const SuperTeamMemberProperty& prop,
                                      const SuperTeamEventCallback& cb,
                                      const std::string& json_extension /* = ""*/) {
    ...
    NIM_SDK_GET_FUNC(nim_super_team_update_my_property_async)
    (prop.ToJsonString().c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::ApplyJoinAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_apply_join_async)(tid.c_str(), reason.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::PassJoinApplyAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_pass_join_apply_async)
    (tid.c_str(), applicant_id.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::RejectJoinApplyAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_reject_join_apply_async)
    (tid.c_str(), applicant_id.c_str(), reason.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::AddManagersAsync(const std::string& tid,
    ...
    std::string uids;
    StrListToJsonString(ids, uids);
    NIM_SDK_GET_FUNC(nim_super_team_add_managers_async)(tid.c_str(), uids.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::RemoveManagersAsync(const std::string& tid,
    ...
    std::string uids;
    StrListToJsonString(ids, uids);
    NIM_SDK_GET_FUNC(nim_super_team_remove_managers_async)(tid.c_str(), uids.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::TransferTeamAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_transfer_team_async)
    (tid.c_str(), new_owner_id.c_str(), is_leave, json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);

    return true;
}

bool SuperTeam::UpdateOtherNickAsync(const SuperTeamMemberProperty& prop,
                                     const SuperTeamEventCallback& cb,
                                     const std::string& json_extension /* = ""*/) {
    ...
    NIM_SDK_GET_FUNC(nim_super_team_update_other_nick_async)
    (prop.ToJsonString().c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::AcceptInvitationAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_accept_invitation_async)
    (tid.c_str(), invitor_id.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::RejectInvitationAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_reject_invitation_async)
    (tid.c_str(), invitor_id.c_str(), reason.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);

    return true;
}

bool SuperTeam::MuteMemberAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_mute_member_async)
    (tid.c_str(), member_id.c_str(), set_mute, json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::MuteAsync(const std::string& tid, bool set_mute, const SuperTeamEventCallback& cb, const std::string& json_extension /* = ""*/) {
    ...
    NIM_SDK_GET_FUNC(nim_super_team_mute_async)(tid.c_str(), set_mute, json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
...
bool SuperTeam::QuerySuperTeamsInfoByKeywordAsync(const std::string& keyword,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_query_teams_info_by_keyword_async)
    (keyword.c_str(), json_extension.c_str(), &CallbackQueryAllMySuperTeamsInfo, cb_pointer);
...
bool SuperTeam::QuerySuperTeamMembersAsync(const std::string& tid,
...
bool SuperTeam::QuerySuperTeamMemberAsync(const std::string& tid,
    ...
    NIM_SDK_GET_FUNC(nim_super_team_query_team_member_async)
    (tid.c_str(), id.c_str(), json_extension.c_str(), &CallbackQuerySuperTeamMember, cb_pointer);
...
bool SuperTeam::QuerySuperTeamInfoAsync(const std::string& tid, const QuerySuperTeamInfoCallback& cb, const std::string& json_extension /* = ""*/) {
    ...
    NIM_SDK_GET_FUNC(nim_super_team_query_team_info_async)(tid.c_str(), json_extension.c_str(), &CallbackQuerySuperTeamInfo, cb_pointer);
...
bool SuperTeam::QuerySuperTeamInfoOnlineAsync(const std::string& tid, const SuperTeamEventCallback& cb, const std::string& json_extension /* = ""*/) {
    ...
    NIM_SDK_GET_FUNC(nim_super_team_query_team_info_online_async)(tid.c_str(), json_extension.c_str(), &CallbackSuperTeamChange, cb_pointer);
