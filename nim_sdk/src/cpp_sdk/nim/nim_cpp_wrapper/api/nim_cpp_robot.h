...
public:
    typedef std::function<void(NIMResCode rescode, NIMRobotInfoChangeType type, const RobotInfos&)>
        RobotChangedCallback;                                                                    /**< 机器人信息变更事件通知回调模板 */
    ...
    /** @fn void GetRobotInfoAsync(const int64_t timetag, const RobotQueryCallback &callback, const std::string &json_extension = "");
     * 获取机器人信息
