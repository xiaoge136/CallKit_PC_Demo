    ...
    (
        ...
        [](int rescode, const void* user_data) {
            CallbackProxy::DoSafeCallback<UpdateSessionInfoCallback>(
                user_data, [=](const UpdateSessionInfoCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode); }, true);
        },
        cb_pointer);
}
    ...
    (
        ...
        [](int rescode, const void* user_data) {
            CallbackProxy::DoSafeCallback<DeleteSessionInfoCallback>(
                user_data, [=](const DeleteSessionInfoCallback& cb) { CallbackProxy::Invoke(cb, (nim::NIMResCode)rescode); }, true);
        },
        cb_pointer);
}
