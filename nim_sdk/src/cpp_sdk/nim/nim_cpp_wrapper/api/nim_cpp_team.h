...
public:
    ...
    typedef std::function<void(int team_count, const std::list<nim::TeamInfo>& team_info_list)>
        QueryAllMyTeamsInfoCallback; /**< 查询本人所有群信息回调模板 */
    typedef std::function<void(int count, const std::list<nim::TeamMemberProperty>& all_my_member_info_list)>
        QueryMyAllMemberInfosCallback; /**< 查询本人所有群里我的成员信息回调模板 */
    typedef std::function<void(const std::string& tid, int member_count, const std::list<TeamMemberProperty>& props)>
        QueryTeamMembersCallback; /**< 查询指定群组全部成员信息回调模板 */
    ...
    typedef std::function<void(NIMResCode error_code, const std::string& tid, const std::list<TeamMemberProperty>& team_member_propertys)>
        QueryTeamMembersOnlineCallback; /**< 查询群成员信息回调模板 */
    typedef std::function<void(NIMResCode, const std::string&, const std::map<std::string, std::string>&)>
        QueryTeamMembersInvitorCallback; /**< 查询群成员邀请人accid 列表回调模板 */
    ...
    typedef std::function<void(const std::list<std::string>& success_ids, const std::list<std::string>& failure_ids)>
        UpdateTInfoLocalCallback; /**< 更新本地缓存回调模板顺丰专用 */
    typedef std::function<void(const std::string& tid,
    ...
    typedef std::function<void(NIMResCode error_code, const std::list<nim::TeamInfo>& team_info_list, const std::list<std::string>& fail_list)>
        GetTeamInfoListCallback; /**< 查询给定的一组群ID详细信息的回调模板 */
    ...
    /** @fn static bool CreateTeamAsync(const TeamInfo& team_info,
    ...
    /** @fn static bool InviteAsync(const std::string& tid,
                                    const std::list<std::string>& ids,
                                    const std::string& invitation_postscript,
                                    const TeamEventCallback& cb,
                                    const std::string& json_extension = "")
    ...
    /** @fn static bool InviteAsync2(const std::string& tid,
                                     const std::list<std::string>& ids,
                                     const std::string& invitation_postscript,
    ...
    /** @fn static bool KickAsync(const std::string& tid,
                                  const std::list<std::string>& ids,
                                  const TeamEventCallback& cb,
                                  const std::string& json_extension = "")
     * 踢人
     ...
     *                803:群不存在
     */
    static bool KickAsync(const std::string& tid,
                          const std::list<std::string>& ids,
                          const TeamEventCallback& cb,
                          const std::string& json_extension = "");
    ...
    /** @fn static bool UpdateTeamInfoAsync(const std::string& tid,
    ...
    /** @fn static bool ApplyJoinAsync(const std::string& tid,
    ...
    /** @fn static bool PassJoinApplyAsync(const std::string& tid,
    ...
    /** @fn static bool RejectJoinApplyAsync(const std::string& tid,
                                             const std::string& applicant_id,
                                             const std::string& reason,
                                             const TeamEventCallback& cb,
                                             const std::string& json_extension = "")
    ...
    /** @fn static bool AddManagersAsync(const std::string& tid,
                                         const std::list<std::string>& ids,
                                         const TeamEventCallback& cb,
                                         const std::string& json_extension = "")
     * 添加管理员
    ...
    /** @fn static bool RemoveManagersAsync(const std::string& tid,
                                            const std::list<std::string>& ids,
                                            const TeamEventCallback& cb,
                                            const std::string& json_extension = "")
     * 删除管理员
    ...
    /** @fn static bool TransferTeamAsync(const std::string& tid,
    ...
    /** @fn static bool AcceptInvitationAsync(const std::string& tid,
    ...
    /** @fn static bool RejectInvitationAsync(const std::string& tid,
                                              const std::string& invitor_id,
                                              const std::string& reason,
                                              const TeamEventCallback& cb,
                                              const std::string& json_extension = "")
    ...
    /** @fn static bool QueryTeamMemberAsync(const std::string& tid,
                                             const std::string& id,
    ...
    /** @fn static bool MuteMemberAsync(const std::string& tid,
     ...
     *                802:没有权限
     */
    static bool MuteMemberAsync(const std::string& tid,
                                const std::string& member_id,
                                bool set_mute,
                                const TeamEventCallback& cb,
                                const std::string& json_extension = "");
    ...
    /** @fn static void TeamMsgAckRead(const std::string& tid,
     ...
     *                414:参数错误
     */
    static void TeamMsgAckRead(const std::string& tid,
                               const std::list<IMMessage>& msgs,
                               const TeamEventCallback& cb,
                               const std::string& json_extension = "");

    /** @fn static void TeamMsgAckReadEx(const std::string& tid,
                                         const std::list<IMMessage>& msgs,
     ...
     *                414:参数错误
     */
    static void TeamMsgAckReadEx(const std::string& tid,
                                 const std::list<IMMessage>& msgs,
                                 const TeamMsgAckReadCallback& cb,
                                 const std::string& json_extension = "");

    /** @fn static void TeamMsgQueryUnreadList(const std::string& tid,
                                               const IMMessage& msg,
                                               const TeamEventCallback& cb,
                                               const std::string& json_extension = "")
     * 获取群消息未读成员列表
     ...
     *                414:参数错误
     */
    static void TeamMsgQueryUnreadList(const std::string& tid,
                                       const IMMessage& msg,
                                       const TeamEventCallback& cb,
                                       const std::string& json_extension = "");
    ...
    /** @fn static bool QueryTeamInfoByKeywordAsync(const std::string& keyword,
    ...
    /** @fn static void UpdateTInfoLocal(const std::list<TeamInfo>& team_infos,
    ...
    /** @fn static void GetTeamInfoBatchSFTrans(const GetTeamInfoBatchSFTransCallback& cb,
                                                uint64_t  time_tag = 0,
                                                const std::string& json_extension = "")
     * 查询所有群顺丰专用
     * @param[in] cb        查询所有群的回调函数
