...
public:
    ...
    /** @fn static void SendMsg(const std::string& json_msg, const std::string& json_extension = "", FileUpPrgCallback* pcb = nullptr)
     * 发送消息
    ...
    /** @fn static std::string CreateTextMessage(const std::string& receiver_id,
    ...
    /** @fn static std::string CreateImageMessage(const std::string& receiver_id,
                                                  const NIMSessionType session_type,
                                                  const std::string& client_msg_id,
                                                  const IMImage& image,
    ...
    /** @fn static std::string CreateFileMessage(const std::string& receiver_id,
                                                 const NIMSessionType session_type,
                                                 const std::string& client_msg_id,
                                                 const IMFile& file,
                                                 const std::string& file_path,
    ...
    /** @fn static std::string CreateAudioMessage(const std::string& receiver_id,
                                                  const NIMSessionType session_type,
                                                  const std::string& client_msg_id,
                                                  const IMAudio& audio,
                                                  const std::string& file_path,
    ...
    /** @fn static std::string CreateVideoMessage(const std::string& receiver_id,
                                                  const NIMSessionType session_type,
                                                  const std::string& client_msg_id,
                                                  const IMVideo& video,
                                                  const std::string& file_path,
    ...
    /** @fn static std::string CreateLocationMessage(const std::string& receiver_id,
                                                     const NIMSessionType session_type,
                                                     const std::string& client_msg_id,
    ...
    /** @fn static std::string CreateTipMessage(const std::string& receiver_id,
                                                const NIMSessionType session_type,
                                                const std::string& client_msg_id,
                                                ...
                                                int64_t timetag = 0,
                                                int32_t sub_type = 0)
     * 生成 Tips 消息内容,生成的字符串在调用SendMsg时直接传入
     *  @param[in] receiver_id 聊天对象的 ID,如果是单聊,为用户帐号,如果是群聊,为群组 ID
     *  @param[in] session_type NIMSessionType,聊天类型,单聊或群组
     *  @param[in] client_msg_id 客户端消息id,建议uuid
    ...
    /** @fn static std::string CreateBotRobotMessage(const std::string& receiver_id,
                                                     const NIMSessionType session_type,
                                                     const std::string& client_msg_id,
                                                     const std::string& content,
    ...
    /** @fn static std::string CreateG2NetCallMessage(const std::string& receiver_id,
                                                      const NIMSessionType session_type,
                                                      const std::string& client_msg_id,
    ...
    /** @fn static std::string CreateRetweetMessage(const std::string& src_msg_json,
                                                    const std::string& client_msg_id,
    ...
    /** @fn static void RecallMsg(const IMMessage &msg,
    ...
    /** @fn static void RecallMsg2(const IMMessage& msg,
                                   const std::string& notify,
                                   const RecallMsgsCallback& cb,
     ...
     *                10508:本地错误码,超过配置有效期或者所需参数不存在
     */
    static void RecallMsg2(const IMMessage& msg,
                           const std::string& notify,
                           const RecallMsgsCallback& cb,
                           const std::string& apnstext = "",
                           const std::string& pushpayloadconst = "",
    ...
    /** @fn static void RecallMsgEx(const IMMessage& msg,
                                    const std::string& notify,
                                    const RecallMsgsCallback& cb,
