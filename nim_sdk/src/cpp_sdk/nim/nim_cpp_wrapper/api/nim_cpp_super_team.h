...
public:
    ...
    typedef std::function<void(int team_count, const std::list<std::string>& team_id_list)>
        QueryAllMySuperTeamsCallback; /**< 查询本人所有群ID回调模板 */
    typedef std::function<void(int team_count, const std::list<nim::SuperTeamInfo>& team_info_list)>
        QueryAllMySuperTeamsInfoCallback; /**< 查询本人所有群信息回调模板 */
    typedef std::function<void(int count, const std::list<nim::SuperTeamMemberProperty>& all_my_member_info_list)>
        QueryMyAllMemberInfosCallback; /**< 查询本人所有群里我的成员信息回调模板 */
    typedef std::function<void(NIMResCode error_code, const std::string& tid, int member_count, const std::list<SuperTeamMemberProperty>& props)>
        QuerySuperTeamMembersCallback; /**< 查询指定群组全部成员信息回调模板 */
    ...
    typedef std::function<void(NIMResCode error_code, const std::string& tid, const std::list<SuperTeamMemberProperty>& team_member_propertys)>
        QuerySuperTeamMembersOnlineCallback; /**< 查询群成员信息回调模板 */
    ...
    /** @fn static bool UpdateSuperTeamInfoAsync(const std::string& tid,
    ...
    /** @fn static bool UpdateMyPropertyAsync(const SuperTeamMemberProperty& prop,
                                              const SuperTeamEventCallback& cb,
                                              const std::string& json_extension = "")
     * 更新自己的群属性
     * @param[in] prop    群成员属性
    ...
    /** @fn static bool QuerySuperTeamsInfoByKeywordAsync(const std::string& keyword,
     ...
     * @return bool 检查参数如果不符合要求则返回失败
     */
    static bool QuerySuperTeamsInfoByKeywordAsync(const std::string& keyword,
                                                  const QueryAllMySuperTeamsInfoCallback& cb,
                                                  const std::string& json_extension = "");
    ...
    /** @fn static void QuerySuperTeamMembersAsync(const std::string& tid,
    ...
    /** @fn static bool QuerySuperTeamMemberAsync(const std::string& tid,
                                                  const std::string& id,
    ...
    /** @fn static bool QuerySuperTeamInfoOnlineAsync(const std::string& tid,
                                                      const SuperTeamEventCallback& cb,
                                                      const std::string& json_extension = "")
     * 获取群信息（从服务器获取）
     * @param[in] tid        群组id
